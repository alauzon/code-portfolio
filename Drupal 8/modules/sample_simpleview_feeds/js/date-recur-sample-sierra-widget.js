...
(function ($, Drupal, debounce) {
  Drupal.behaviors.sierraWidgetRecurrences = {
    attach: function attach(context, settings) {
      var $recurrenceOptionDropdowns = $(context).find('.date-recur-sample-sierra-widget .date-recur-sample-sierra-widget-recurrence-option').once('date-recur-sample-sierra-widget-recurrence-option');
      $recurrenceOptionDropdowns.each(function () {
        $(this).change(function() {
          ...
          if ('custom_open' === value) {
            ...
            rules button. */
            var $recurrenceOpen = $(this).closest('.date-recur-sample-sierra-widget').find('.date-recur-sample-sierra-widget-recurrence-open');
      ...
      var $startDates = $(context).find('.date-recur-sample-sierra-widget .date-recur-sample-sierra-widget-start-date').once('date-recur-sample-sierra-widget-start-date');
      $startDates.each(function () {
        $(this).on('change', debounce(function () {
          $(this).closest('.date-recur-sample-sierra-widget').find('.date-recur-sample-sierra-widget-reload-recurrence-options').click();
          ...
          if ($startMatches !== null) {
            ...
            var $endDateElement = $(this).closest('.date-recur-sample-sierra-widget').find('.date-recur-sample-sierra-widget-start-end');
            var $endDate = null;
