...
use Drupal\sample_simpleview_feeds\Form\DateRecurSampleSierraModalOccurrencesForm;
use Drupal\sample_simpleview_feeds\Form\DateRecurSampleSierraModalForm;
 ...
 *
 * @FieldWidget(
 *   id = "date_recur_sample_sierra",
 *   label = @Translation("Sample Simpleview Feeds: Sierra"),
 *   field_types = {
 *     "date_recur"
 *   }
 * )
 */
class DateRecurSampleSierraWidget extends DateRecurModularWidgetBase {
   ...
   */
  public const COLLECTION_MODAL_STATE = 'date_recur_sample_sierra_modal_state';
   ...
   * Form state key.
   */
  protected const FORM_STATE_RRULE_KEY = 'date_recur_sample_sierra_rrule';
  ...
  /**
   * Constructs a new DateRecurSampleSierraWidget.
   *
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state): array {
    ...
    $element['#theme'] = 'date_recur_sample_sierra_widget';
    ...
    $element['buttons']['custom_recurrences'] = [
      ...
      '#attributes' => [
        'class' => [
          'js-hide',
          'date-recur-sample-sierra-widget-recurrence-open',
        ],
      ],
    ...
    $element['buttons']['reload_recurrence_dropdown'] = [
      ...
      '#attributes' => [
        'class' => [
          'js-hide',
          'date-recur-sample-sierra-widget-reload-recurrence-options',
        ],
      ],
      '#limit_validation_errors' => [],
      // Needs a name so triggering element works on multicardinal elements.
    ...
    $element['day_start'] = [
      ...
      '#attributes' => [
        'type' => 'date',
        'class' => ['date-recur-sample-sierra-widget-start-date'],
      ],
    ...
    $element['day_end'] = [
      ...
      '#attributes' => [
        'type' => 'date',
        'class' => ['date-recur-sample-sierra-widget-start-end'],
      ],
      '#date_date_format' => 'Y-m-d',
    ];
    ...
    $element['recurrence_option'] = [
      ...
      '#suffix' => '</div>',
      '#attributes' => [
        'class' => ['date-recur-sample-sierra-widget-recurrence-option'],
      ],
    ];
    ...
    $element['occurrences'] = [
      ...
      '#attributes' => [
        'class' => [
          'date-recur-sample-sierra-widget-occurrences-open',
        ],
      ],
      '#limit_validation_errors' => [],
  ...
  public function openTheModal(array &$form, FormStateInterface $form_state) {
    ...
    // Open modal.
    $content = $this->formBuilder->getForm(DateRecurSampleSierraModalForm::class);
  ...
  public function openOccurrencesModal(array &$form, FormStateInterface $form_state) {
    ...
    // Open modal.
    $content = $this->formBuilder->getForm(DateRecurSampleSierraModalOccurrencesForm::class);
    $content['#attached']['library'][] = 'core/drupal.dialog.ajax';
    $dialogOptions = ['width' => '575'];
    return (new AjaxResponse())
      ->setAttachments($content['#attached'])
   ...
   */
  protected function getInterpreter(): ?EntityInterface
  {
