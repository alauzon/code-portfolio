 ...
 */
class DateRecurSampleSierraModalOccurrencesForm extends FormBase {
  ...
  public function getFormId() {
    return 'date_recur_sample_sierra_occurrences_modal';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['#attached']['library'][] = 'sample_simpleview_feeds/sierra_modal_occurrences_form';
    $form['#attached']['library'][] = 'core/drupal.ajax';
    $form['#theme'] = 'date_recur_sample_sierra_widget_modal_occurrences_form';

    $collection = $this->tempStoreFactory->get(DateRecurSampleSierraWidget::COLLECTION_MODAL_STATE);
    /** @var string|null $rrule */
    $rrule = $collection->get(DateRecurSampleSierraWidget::COLLECTION_MODAL_STATE_KEY);
    /** @var string $dateFormat */
    $dateFormatId = $collection->get(DateRecurSampleSierraWidget::COLLECTION_MODAL_DATE_FORMAT);
    ...
    $form['occurrences']['show_more']['show_more'] = [
      ...
      '#ajax' => [
        ...
        'url' => Url::fromRoute('date_recur_sample_widget.sierra_modal_occurrences_form'),
        'options' => [
          'query' => [
